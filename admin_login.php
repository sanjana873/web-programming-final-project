...
<nav class="navbar navbar-expand-lg bg-light fixed-top shadow-lg">
            ...
            <li class="nav-item">
                        <a href="login.php" class="nav-link">Seller or Buyer</a>
            </li>
        ...
        <div class="content1">
            <header>SignIn as Admin</header>
            <form action = "admin_login_submit.php" method="POST">
               <div class="field space">
                  <span class="fa fa-lock"></span>
                  <input type="text" class="pass-key" name = "admin_user_id_login"  id="admin_user_id_login" required placeholder="UserId">
               </div>
               <div class="field space">
                  <span class="fa fa-lock"></span>
                  <input type="password" class="pass-key" name = "admin_password_login" id="admin_password_login" required placeholder="Password">
               </div>
               <div class="field">
