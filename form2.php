...
<div class="content">
            ...
            <form action = "insert_card_admin.php" method="POST" enctype="multipart/form-data" >
               <div class="field space">
                  <input type="text" id="seller_user_id" name="seller_user_id" value="<?php echo $_COOKIE['username1']; ?>">
