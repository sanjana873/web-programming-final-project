...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-light fixed-top shadow-lg">
            ...
            <li class="nav-item">
                        <a href="register.php" class="nav-link">Seller</a>
            </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle click-scroll" href="#section_3" id="navbarLightDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">Buy</a>

                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                <li><a class="dropdown-item" href="register.php">Show Listing</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 text-center mx-auto">
                            <div class="hero-section-text">
                                ...
                                <h1 class="hero-title text-black mt-2 mb-4">Find a lovely place to call home.</h1>

                                <form class="custom-form hero-form" action="register.php" method="get" role="form">
                                        <div class="col-lg-2 col-md-6 col-12" style="display: contents;">
                                            <button type="submit" class="form-control">Show Living Spaces</button>
                                        </div>
                                </form>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-5 col-12">
                            ...
                            <h2 class="mt-2 mb-4"><span class="text-muted">Introducing</span> UrbanNest Plaza</h2>

                            <h4 class="text-muted mb-3">Since 2021, We Sold Beautiful Homes for better Lives</h4>

                            <p>Being you, luxury is nothing new. For a high-flyer, you've always experienced life at the very top with premium 5 bhk & 6 bhk luxurious Flats in Atlanta. And now we take it many notches higher - by 136 floors! At UrbanNest Plaza, luxury property sees even greater heights. Spread across 180 acres. UrbanNest Plaza, gated community in Atlanta with exclusive 5bhk flats & 6bhk flats is situated in most premium location - Downtown Atlanta. Our contemporary towers don't just breathe luxury, but also boast of a magnificent view of the bio-diversity park on one side, and the cityscape on the other.

Living Spaces Limited is an iconic project that stands 25 floors tall, making it one of the tallest residential towers & luxury apartments in Downtown Atlanta. There's no better view of the success you've achieved in life, than from up here.

It gives you the best of what life has to offer, and enjoyed only by the select few. Come up to UrbanNest Plaza, and experience a life above!</p>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12">
                            <small class="section-small-title">UrbanNest Shop</small>

                            <h2 class="mt-2 mb-4"><span class="tooplate-red">Living</span> Spaces</h2>
                        </div>

                        <div class="col-lg-6 col-12">
                            <div class="shop-thumb">
                                <div class="shop-imagel-wrap">
                                    <a href="register.php">
                                        <img src="images/shop/minimal-bathroom-interior-design-with-wooden-furniture.jpg" class="shop-image img-fluid" alt="">
                                    </a>

                                    <div class="shop-btn-wrap">
                                        <a href="register.php" class="shop-btn custom-btn btn d-flex align-items-center align-items-center">Learn more</a>
                                    </div>
                                </div>
